...
//                options.UseSqlServer(Configuration.GetConnectionString("CCTContext"));
...
//                        new CCTContext(Configuration.GetConnectionString("CCTContext")))
//                    .AddScoped(_ =>
//                        new StudentTimesheetsEntities(Configuration.GetConnectionString("StudentTimesheetsEntities")))
//                    .AddScoped(_ =>
//                        new StaffTimesheetsEntities(Configuration.GetConnectionString("StaffTimesheetsEntities")))
//                    .AddScoped(_ =>
//                        new MyGordonEntities(Configuration.GetConnectionString("MyGordonEntities")));
