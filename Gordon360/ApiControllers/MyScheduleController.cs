...
//
//            var result = _myScheduleService.Get(idInt);
//            if (result == null)
//            {
//                return NotFound();
//            }
...
//        /// <param name="id">The identifier for the myschedule to be deleted</param>
//        /// <remarks>Calls the server to make a call and remove the given myschedule from the database</remarks>
//        // DELETE api/<controller>/5
//        [HttpDelete]
//        [Route("delete/{id}")]
//        public IHttpActionResult Delete(int id) //TODO: MAKE THIS USE THE KEY OF THE MYSCHEDULE TABLE
//        {
//            var result = _myScheduleService.Delete(id);
//
//            if (result == null)
//            {
//                return NotFound();
...
//        }
//
//        /// <summary>Delete all myschedule items for a user</summary>
//        /// <param name="id">The identifier for the user whose myschedule is to be deleted</param>
//        /// <remarks>Calls the server to make a call and remove the given myschedules from the database</remarks>
//        // DELETE api/<controller>/5
//        [HttpDelete]
//        [Route("deleteall")]
...
//
//            var idInt = Int32.Parse(id);
//            var result = _myScheduleService.DeleteAllForID(idInt);
//
//            if (result == null)
//            {
//                return NotFound();
