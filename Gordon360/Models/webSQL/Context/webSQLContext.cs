...
public partial class webSQLContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.account_id).HasName("PK_account_1");
            ...
            entity.HasIndex(e => e.AD_Username, "IX_account").HasFillFactor(90);

            entity.HasIndex(e => e.AD_Username, "IX_account_ad_username").HasFillFactor(90);
            ...
            entity.HasIndex(e => e.AD_Username, "ix_AD_Username_Includes2").HasFillFactor(100);
