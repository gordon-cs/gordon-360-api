...
{
    public partial class Gordon360Context
    {
        private IGordon360ContextProcedures _procedures;

        public virtual IGordon360ContextProcedures Procedures
        {
            get
            {
                if (_procedures is null) _procedures = new Gordon360ContextProcedures(this);
                return _procedures;
            }
            set
            {
        ...
        public IGordon360ContextProcedures GetProcedures()
        {
            return Procedures;
        }
    ...
    public partial class Gordon360ContextProcedures : IGordon360ContextProcedures
    {
        private readonly Gordon360Context _context;

        public Gordon360ContextProcedures(Gordon360Context context)
        {
            _context = context;
        }
