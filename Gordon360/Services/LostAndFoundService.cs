...
namespace Gordon360.Services
{
    public class LostAndFoundService(CCTContext context) : ILostAndFoundService
    {
        ...
        public int CreateActionTaken(int missingItemID, ActionsTakenViewModel ActionsTaken, string username)
        {
            ...
            {
                throw new ResourceCreationException() { ExceptionMessage = "No account could be found for the requesting user." };
            }
            ...
            // If the report belongs to the requesting user, or the user is an admin
        ...
        /// <exception cref="UnauthorizedAccessException">If a username without admin permissions attempts to use</exception>
        ...
        /// <exception cref="ResourceNotFoundException">For admin users, if the report with given ID doesn't exist</exception>
        /// <exception cref="UnauthorizedAccessException">For general users, if the report with given ID doesn't belong to them, 
        /// or doesn't exist.</exception>
        ...
        /// <exception cref="UnauthorizedAccessException">Attemps by a non-admin user to get actions for 
        /// a report which doesn't belong to them will yield an UnauthorizedAccessException</exception>
