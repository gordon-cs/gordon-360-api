...
//        public DirectMessageService(CCTContext context)
//        {
//            _context = context;
...
//            var query = _context.ACCOUNT.FirstOrDefault(x => x.gordon_id == user_id);
//            if (query == null)
//            {
...
//        {
//            var _unitOfWork = new UnitOfWork();
//            var query = _context.ACCOUNT.FirstOrDefault(x => x.gordon_id == userId);
//            if (query == null)
//            {
//                throw new ResourceNotFoundException() { ExceptionMessage = "The account was not found." };
//            }
...
//                var query = _context.ACCOUNT.FirstOrDefault(x => x.gordon_id == user);
//                if (query == null)
//                {
