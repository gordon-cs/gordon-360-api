...
namespace Gordon360.Services
{
    ...
    {
        IEnumerable<ScheduleViewModel> GetScheduleStudent(int id, string session_code);
        IEnumerable<ScheduleViewModel> GetScheduleFaculty(int id, string session_code);
