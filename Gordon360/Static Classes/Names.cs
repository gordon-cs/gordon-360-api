...
public static class Resource
{
    ...
    public const string PROFILE_PRIVACY = "An individual's specific profile privacy resource";
    ...
    public const string HOUSING_PHONE_NUMBERS = "Phone numbers related to student life";
