...
-- Description:	Fetch all Leaders for a specified activity.
-- =============================================
CREATE PROCEDURE LEADER_MEMBERSHIPS_PER_ACT_CDE 
...
WHERE mem.ACT_CDE =@ACT_CDE AND mem.PART_CDE in ('CAPT','CODIR','CORD','DIREC','PRES','VICEC','VICEP')
END
GO
