...
define('test-app/models/activity', ['exports', 'ember-data/model', 'ember-data/attr'], function (exports, _emberDataModel, _emberDataAttr) {
...
define('test-app/services/activity-store', ['exports', 'ember-data'], function (exports, _emberData) {
  exports['default'] = _emberData['default'].Service.extend({});
});
...
if (!runningTests) {
  require("test-app/app")["default"].create({"name":"test-app","version":"0.0.0+3e015a82"});
}
