...
- Before you publish your new version, be sure to copy the current stable version to make a backup. To do so:
	- Navigate in File Explorer to `F:\Sites` and copy either 360Api of 360ApiTrain, whichever you're planning to publish to.
	- Paste that copy in the same place (`F:\Sites`), and rename it to to a backup including the day. For example, of you backed up the Train site on January 1, 2001, then the copy would be named `360ApiTrain_backup 1-01-2001`.
