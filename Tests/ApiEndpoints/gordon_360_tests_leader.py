...
class get_all_activities___activity_leader(TestCase):
...
class get_one_activity___activity_leader(TestCase):
...
class get_activities_for_session___activity_leader(TestCase):
    ...
    def setup(self):
        ...
        try:
            ...
            self.log_error('Error in setup for {0}. Expected json in response body, got {1}.'.format(self.test_name, response.text))
        else:
            try:
                self.sessionID = response.json()['SessionCode']
            except KeyError:
                self.log_error('Error in setup for {0}. Expected SessionCode in response body, got {1}.'.format(self.test_name, response.json()))
...
class update_activity___activity_leader(TestCase):
    ...
    def test(self):
        ...
        try:
            ...
            try:
                ...
                self.log_error('Expected ACT_CDE in response body, got {0}.'.format(response.json()))

class update_activity_image___activity_leader(TestCase):
    """ Verify that an activity leader can update the activity image.

    Pre-Conditions:
    Valid Authentication Header
    Authenticated as an activity leader
    Expectations:
    Endpoint -- api/activities/:id/image
    Expected Status Code -- 200 OK
    Expected Json response -- Empty respons body.
    """
    def __init___(self, session=None):
        pass
    def setup(self):
        pass
    def test(self):
...
class get_all_participations___activity_leader(TestCase):
...
class get_one_participation___activity_leader(TestCase):
...
class get_all_sessions___activity_leader(TestCase):
...
class get_one_session___activity_leader(TestCase):
...
class get_all_students___activity_leader(TestCase):
...
class get_student_by_id___activity_leader(TestCase):
...
class get_student_by_email___activity_leader(TestCase):
    """ Verify that an activity leader get a student resource by email.
